module Tarefa4_2021li1g054_Spec where
...
testsT4 =
  test
    ...
    , "Tarefa 4 - Teste movimentos m2e1" ~: m3e1 ~=? correrMovimentos m2e1 [InterageCaixa,AndarEsquerda,AndarEsquerda,AndarEsquerda,InterageCaixa] --Testa quase todos os casos num teste só
    ]